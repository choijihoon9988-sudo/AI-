        ...
        <div class="modal-overlay" id="guild-modal-overlay">
            <div class="modal" id="guild-modal">
                <div class="modal-header">
                    <h3 class="modal-title">새 길드 생성</h3>
                    <button class="modal-close-btn" id="guild-modal-close-btn">&times;</button>
                </div>
                <div class="modal-body">
                    <form id="guild-form">
                        <div class="form-group">
                            <label for="guild-name">길드 이름</label>
                            <input class="form-control" type="text" id="guild-name" placeholder="예: 마케팅 팀" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button class="p-btn" id="guild-modal-cancel-btn" type="button">취소</button>
                    <button class="p-btn p-btn-primary" id="guild-modal-save-btn" type="button">생성</button>
                </div>
            </div>
        </div>
    `;
